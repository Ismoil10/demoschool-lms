...
$sds = db::arr_by_id("SELECT * FROM student_students");
...
<? else: ?>
    <div class="card">
        <div class="card-header justify-content-center">
            <h3>😢 Maʼlumotlar topilmadi</h3>
        </div>

        <div class="card-body d-flex flex-column align-items-center">
            <img class="w-25" src="<?= $template_path ?>/app-assets/images/pages/under-maintenance.svg" alt="data not found">
            <p class="mt-2 text-info">
                Siz soʻragan maʼlumotlar topilmadi.
            </p>
        </div>
    </div>
<? endif; ?>
