...
<?
if ($link_type=='single'){
if ($_GET['page']=='task_list' AND $_SESSION['page_action_cc']=='list'){require 'task_list_list.php';}
...
if ($link_type=='multi'){
if ($_GET['page']=='task_list' AND $_GET['page_action']=='list'){require 'task_list_list.php';}
