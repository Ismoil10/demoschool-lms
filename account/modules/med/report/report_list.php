          ...
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                ...
                <pre><?//print_r("SELECT TYPE, SUM(AMOUNT) as amount FROM `transaction_list` WHERE $sql_total_query `ACTION_TYPE`='expense' AND TRANSACTION_DATE BETWEEN '$from' AND '$to' GROUP BY `TYPE`")?></pre>
              </ol>
            </div>
          </div>
        </div>
