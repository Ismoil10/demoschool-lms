<?
$student_list = db::arr("SELECT * FROM `student_list` WHERE ACTIVE=1 $sql_org_id AND ID IN (SELECT STUDENT_ID FROM `subscribe_list` WHERE `ACTIVE`=1 AND `STATUS`='demo') ORDER BY ID DESC");
?>
