<?
$student_list = db::arr("SELECT * FROM `student_list` WHERE ID IN (SELECT ITEM_ID FROM `table_log` WHERE `ACTION`='add_student' AND `ACTIVE`=1 AND `LOG_DATE` BETWEEN '" . date("Y-m-01") . "' AND '" . date("Y-m-t 23:59:59") . "')  $sql_org_id  ORDER BY ID DESC");
?>
